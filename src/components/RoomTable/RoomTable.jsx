...
const RoomTable = ({ roomList, onEdit, onDelete }) => {
  const getRoomTypeBadge = (room) => {
    ...
    if (room.type === 'lab') {
      bg = 'var(--warning-bg)';
      color = 'var(--warning)';
      icon = <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M10 2v7.31"></path><path d="M14 9.3V1.99"></path><path d="M8.5 2h7"></path><path d="M14 9.3a6.5 6.5 0 1 1-4 0"></path><path d="M5.52 16h12.96"></path></svg>;
    }
