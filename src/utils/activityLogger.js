...
export const LOG_ACTIONS = {
  ...
  BATCH_DELETE_FACULTY: 'BATCH_DELETE_FACULTY',

  // Subject
  ADD_SUBJECT: 'ADD_SUBJECT',
  UPDATE_SUBJECT: 'UPDATE_SUBJECT',
  DELETE_SUBJECT: 'DELETE_SUBJECT',
  BATCH_DELETE_SUBJECTS: 'BATCH_DELETE_SUBJECTS',

  // Room
  ADD_ROOM: 'ADD_ROOM',
  UPDATE_ROOM: 'UPDATE_ROOM',
  DELETE_ROOM: 'DELETE_ROOM',
  BATCH_DELETE_ROOMS: 'BATCH_DELETE_ROOMS',

  // Section
  ADD_SECTION: 'ADD_SECTION',
  UPDATE_SECTION: 'UPDATE_SECTION',
  DELETE_SECTION: 'DELETE_SECTION',
  BATCH_DELETE_SECTIONS: 'BATCH_DELETE_SECTIONS',

  // Department
  ADD_DEPARTMENT: 'ADD_DEPARTMENT',
  UPDATE_DEPARTMENT: 'UPDATE_DEPARTMENT',
  DELETE_DEPARTMENT: 'DELETE_DEPARTMENT',
  BATCH_DELETE_DEPARTMENTS: 'BATCH_DELETE_DEPARTMENTS',

  // Course
  ADD_COURSE: 'ADD_COURSE',
  UPDATE_COURSE: 'UPDATE_COURSE',
  DELETE_COURSE: 'DELETE_COURSE',
  BATCH_DELETE_COURSES: 'BATCH_DELETE_COURSES',
  ...
  BATCH_RESTORE_DATA: 'BATCH_RESTORE_DATA',
...
export const ACTION_LABELS = {
  ...
  BATCH_DELETE_USERS:     'Batch Deleted Users',
  RESTORE_DATA:           'Restored from Trash',
  PERMANENT_DELETE:       'Permanently Deleted',
  EMPTY_RECYCLE_BIN:      'Emptied Recycle Bin',
  BATCH_RESTORE_DATA:     'Batch Restored from Trash',
  BATCH_PERMANENT_DELETE: 'Batch Permanently Deleted',
...
export const ACTION_COLORS = {
  ...
  UPDATE_USER:            '#f59e0b',
  DELETE_USER:            '#ef4444',
  BATCH_DELETE_USERS:     '#ef4444',
  RESTORE_DATA:           '#10b981',
  BATCH_RESTORE_DATA:     '#10b981',
  PERMANENT_DELETE:       '#dc2626',
  BATCH_PERMANENT_DELETE: '#dc2626',
